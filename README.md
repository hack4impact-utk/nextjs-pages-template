...
- `src/hooks`: Contains custom React hooks used across the project
- `src/pages`: Contains pages for the application using the [NextJS Pages Router](https://nextjs.org/docs/pages)
